        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
              color: isSelected
                  ? AppColors.textColor
                  : AppColors.textColor.withAlpha(67),
              width: 2,
            ),
          ),
        ),
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Divider(color: AppColors.whiteTextColor, height: 1),
          _TierInfoRow(
            label: 'Amount to go',
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: AppColors.textColor.withAlpha(77)),
      ...
      child: Align(
        ...
        child: Text(
          ...
          style: GoogleFonts.tenorSans(
            fontSize: 10.sp,
            fontWeight: FontWeight.w700,
            color: AppColors.textColor.withAlpha(115),
            letterSpacing: 1.5,
          ),
        ),
      ),
...
class _TableDataRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: AppColors.whiteTextColor, width: 0.8),
        ),
      ),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.center,
