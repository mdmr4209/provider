    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
              color: isSelected ? AppColors.textColor : Colors.grey.shade300,
              width: 2.w,
            ),
          ),
        ),
        child: Text(
          ...
          style: GoogleFonts.tenorSans(
            color: isSelected
                ? AppColors.textColor
                : AppColors.textColor.withAlpha(104),
            fontSize: 18.sp,
            fontWeight: FontWeight.w400,
          ),
        ),
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height: 52.w,
            decoration: BoxDecoration(
              color: AppColors.defaultColor.withAlpha(27),
              shape: BoxShape.circle,
            ),
            child: Center(
              child: _TicketIcon(color: AppColors.defaultColor, size: 28.r),
            ),
          ),
          ...
          Text(
            ...
            style: GoogleFonts.lato(
              color: AppColors.textColor.withAlpha(127),
              fontSize: 11.sp,
            ),
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.whiteTextColor, width: 0.8),
            ),
            child: Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    promo.code,
                    style: GoogleFonts.lato(
                      color: AppColors.textColor.withAlpha(152),
                      fontSize: 10.sp,
                ...
                GestureDetector(
                  ...
                  child: Icon(
                    Icons.copy_rounded,
                    size: 16.r,
                    color: AppColors.textColor.withAlpha(104),
                  ),
                ),
              ],
            ),
      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            size: 56.r,
            color: AppColors.defaultColor.withAlpha(77),
          ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(
                Icons.add,
                size: 24.r,
                color: AppColors.textColor.withAlpha(175),
              ),
            ),
          ),
          SizedBox(height: 8.h),
