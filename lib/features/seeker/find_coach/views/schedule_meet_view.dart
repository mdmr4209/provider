...
import 'package:newproject/features/seeker/find_coach/views/payment_view.dart';
...
class ScheduleMeetView extends StatelessWidget {
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.coachColorFF263622,
                    ...
                    return Container(
                      ...
                      decoration: ShapeDecoration(
                        gradient: LinearGradient(
                          begin: Alignment(0.78, 1.00),
                          end: Alignment(0.22, -0.00),
                          colors: [
                            const Color(0xFF364C32),
                            const Color(0xFF253A22),
                          ],
                        ),
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                            width: 1,
                            color: const Color(0xFF53814A),
                          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Divider(color: AppColors.defaultColor),
                          _buildSummaryRow(
                            context,
                            "Total",
  ...
  Widget _buildPickerContainer(
    ...
    return GlassWidget(
      color: AppColors.coachColorFF2D4229,
      child: Container(
  ...
  void _showPaymentTerms(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => PaymentView(controller: controller, slot: slot),
      ),
    );
  }
}
