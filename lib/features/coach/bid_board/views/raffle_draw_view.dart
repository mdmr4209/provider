...
class RaffleDrawView extends StatelessWidget {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                onPress: () async {
                   Navigator.push(context, MaterialPageRoute(builder: (_) => const BuyTicketsView()));
                },
  ...
  Widget _buildRaffleBanner() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.emoji_events_outlined, color: Color(0xFFC19E5F), size: 50),
          SizedBox(width: 16.w),
          const Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Daily Raffle", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
                SizedBox(height: 4),
                Text(
      ...
      child: Row(
        children: [
          ...
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("Congratulations's", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 22)),
              Text("You Win the Spot 5", style: TextStyle(color: Colors.white70, fontSize: 16)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildSummaryCard(CoachBidController controller) {
    return Container(
      ...
      child: Column(
        children: [
          const Text("My Raffle Summary", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
          SizedBox(height: 24.h),
          Row(
            children: [
              Expanded(child: _buildSummaryItem("My Ticket", controller.myTickets.toString())),
              Container(width: 1, height: 40, color: Colors.white12),
              Expanded(child: _buildSummaryItem("Total Coaches", controller.totalCoaches.toString())),
            ],
          ),
        ],
      ),
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            const Icon(Icons.confirmation_number_outlined, color: Color(0xFFC19E5F), size: 18),
            SizedBox(width: 8.w),
