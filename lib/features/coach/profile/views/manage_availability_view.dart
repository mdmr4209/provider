...
class ManageAvailabilityView extends StatelessWidget {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.isOnDays)
                    _buildOnDays(context, controller)
                  else
                    _buildOffDays(context, controller),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSelectionField(
                          ...
                          isSmall: true,
                          onTap: () =>
                              _showTimePicker(context, controller, true),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSelectionField(
                          ...
                          isSmall: true,
                          onTap: () =>
                              _showTimePicker(context, controller, false),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSelectionField(
                          ...
                          isSmall: true,
                          onTap: () =>
                              _showTimePickerOff(context, controller, true),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSelectionField(
                          ...
                          isSmall: true,
                          onTap: () =>
                              _showTimePickerOff(context, controller, false),
                        ),
                      ],
                    ),
                  ),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        color: hint == "Enter here" || hint == "Select one"
            ...
            if (icon != Icons.access_time)
              Icon(icon, color: AppColors.white38Color, size: 18),
          ],
        ),
      ),
    );
  ...
  void _showDayPicker(BuildContext context, CoachProfileController controller) {
    ...
    _showCustomPicker(
      ...
      "Select Day",
      days,
      (val) => controller.setAvailabilityDay(val),
    );
  }
