...
class CoachSetupBaseView extends StatelessWidget {
        ...
        appBar: PreferredSize(
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                // 1. Premium Coach Progress Bar (Shown for Step 2 and above)
                if (currentStep >= 2)
                  Padding(
