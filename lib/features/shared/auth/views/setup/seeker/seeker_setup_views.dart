...
import 'seeker_setup_base_view.dart';
        ...
        children: [
          ...
          Positioned(
            ...
            child: _buildContinueButton(
              ...
              onPress: () {
                if (isCoach) {
                  context.push(AppRoutes.coachSetupComplete);
                } else {
